...
export const BASE_CARDS = Object.freeze([
  { id: 1, kind: "question", question: "配牌時に『00物件』と呼ばれるのは、どのような状態ですか？", answer: "『0メンツ・0両面（両面ターツなし）』という、極めて面子手立直から遠い配牌状態を指します。" },
  { id: 2, kind: "question", question: "『00物件』の出現率は1半荘でどの程度ですか？", answer: "約8％です。1半荘に1回程度です。" },
  ...
  { id: 4, kind: "question", question: "『00物件』でも和了を目指したい場合に優先すべき方針は何ですか？", answer: "役牌、混一、チャンタなど、鳴いて進められる『役』を確保することです。この際、役牌の価値が通常の強孤立牌と逆転することすらあります。" },
  { id: 5, kind: "question", question: "『先オリ』とは、どのような守備行動を指しますか？", answer: "将来の危険に備え、まだ自分の手が形を保っている段階からメンツを壊してでも安全牌を確保することです。" },
  ...
  { id: 7, kind: "question", question: "『配牌降り』とは、具体的にどのような手順を踏みますか？", answer: "1巡目から上がりを放棄し、将来危険になりそうな牌を先に切り飛ばしながら、手牌を安全牌（字牌など）だけで埋め尽くす極端な守備策です。" },
  { id: 8, kind: "question", question: "『中膨れ』の形（例：4556）が『超強孤立』とされる理由は何ですか？", answer: "ターツ生成において圧倒的な柔軟性を持つからです。どの方向へ伸びても良形を作りやすく、ブロックの選択肢を広げる上で最強のくっつき強孤立牌です。" },
  ...
  { id: 16, kind: "question", question: "『3ヘッド』の状態から、安牌を抱えてでも両面を固定すべき理由は何ですか？", answer: "固定しても切った牌の1種類しかロスが出ず、空いたスペースに強孤立牌や安牌を持つことで、良形変化や守備力の向上をノーリスクで狙えるからです。後手強度（押し返し安さ）がUPします。" },
  { id: 17, kind: "question", question: "一向聴において、『将来の良形化（二次変化）』と『ダイレクトのテンパイ待ちの強さ』はどちらを優先しますか？", answer: "『ダイレクトの待ちの強さ』を優先します。" },
  { id: 18, kind: "question", question: "面子手リーチを目指す上で聴牌するまでやってはいけない禁忌二つはなんですか？", answer: "①単独暗刻の破壊 ②唯一雀頭の破壊。※七対子は面子手ではないのでOK。" },
